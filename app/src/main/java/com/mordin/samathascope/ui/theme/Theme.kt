 ...
 * App theme.
 *
 * v0.1 uses a light, high-contrast layout similar to the EEG Meditation app screenshot.
 * Dark mode can be added later; for now we provide a conservative dark scheme so the app
 * doesn't look broken when the device is in dark mode.
 */
